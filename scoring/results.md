...
| `kz_slop_gemini35flash_v5` "Industrial Scaffold Ascent" | Gemini 3.5 Flash | Antigravity subagent | all pass‡ | 428 min | ? | ? | 0 | load-only | 4200u climb, 7 legs × 6 checkpoints, industrial scaffold ascent theme. Validator PASS. Peak 82% at Jump 27 (Leg 5). Avoided leaks. |
